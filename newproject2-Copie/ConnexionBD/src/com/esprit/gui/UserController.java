...
public class UserController implements Initializable {
    ...
    @FXML
    private Button btn_ResLogementUser;
    @FXML
    private Button btn_RestaurantUser;
    @FXML
    private Button ResRestaurantUser;
    @FXML
    ...
    @FXML
    private void ResLogementUser(ActionEvent event) {
    }
    ...
    @FXML
    private void ResRestaurantUser(ActionEvent event) {
    }
