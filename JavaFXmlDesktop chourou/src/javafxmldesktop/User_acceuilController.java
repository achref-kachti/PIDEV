...
public class User_acceuilController implements Initializable {
  ...
  public void setUser(users user)
    ...
    @FXML
    private void go_to_user_logement(ActionEvent event) throws IOException {
                 FXMLLoader loader = new FXMLLoader(getClass().getResource("UserLogement.fxml"));
          
          Parent root = loader.load();
           
             UserLogementController apc5 = loader.getController();
             apc5.setUser(u);
             apc5.rafraichir();
                 btn_user_event.getScene().setRoot(root);
    }
    ...
    @FXML
    private void go_to_user_espece(ActionEvent event) throws IOException {
          FXMLLoader loader = new FXMLLoader(getClass().getResource("UserEspece.fxml"));
          
          Parent root = loader.load();
           
             UserEspeceController apc_8 = loader.getController();
             //apc5.setUser(u);
             //apc5.rafraichir();
             apc_8.setUser(u);
                 btn_user_event.getScene().setRoot(root);
