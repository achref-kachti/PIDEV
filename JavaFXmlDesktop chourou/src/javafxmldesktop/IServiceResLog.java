...
public interface IServiceResLog<T> {
    ...
    int nbrChambRestant( int idLogg, String dateAA, String dateDD) throws SQLException;
   // void rechercher(T t) throws SQLException;
    ...
    List<T> readAllAllResLog(int id) throws SQLException;   
    List<T> PdfResLog() throws SQLException, DocumentException, FileNotFoundException;
    List<T> rechercherLieuRes(String lieuu) throws SQLException;
}
