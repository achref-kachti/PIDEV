...
public class Admin_acceuilController implements Initializable {
    ...
    @FXML
    private JFXButton btn_espece_tazz;
    ...
    private void go_to_logement(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("AdminLogement.fxml"));
             ...
             AdminLogementController apc = loader.getController();
                 btn_event.getScene().setRoot(root);
    ...
    private void go_to_transport(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("AdminVehicule.fxml"));
           
             Parent root = loader.load();
           
             AdminVehiculeController apc = loader.getController();
                 btn_event.getScene().setRoot(root);
    ...
    private void go_to_espece(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("AdminChauffeurs.fxml"));
           
             Parent root = loader.load();
           
             AdminChauffeursController apc = loader.getController();
                 btn_event.getScene().setRoot(root);

    }

    @FXML
    private void go_to_tazz_espece(ActionEvent event) throws IOException {
